...
export default function ProductCard({producto}) {
    return (
        <div className="bg-zinc-900 border border-zinc-700 rounded-xl shadow-md p-4 hover:shadow-2xl hover:border hover:border-blue-600 transition-all duration-200 cursor-pointer ease-in">
